...
class PPMI extends WordEmbeddings {

    private window: number;
    private dictionary: string[];
    private contexts: Map<string, number>;
    ...
    */
    constructor(window: number = 7, dictionary: string[] = [], contexts?: string[]) {
        super();
        this.done = false;
        this.window = window;
        this.contexts = new Map<string, number>();
    ...
    */
    public async complete(dimensions: number) {
        this.contexts.clear();
        const pw = new Map();
        const pc = new Map();
        ...
        if (dimensions && dimensions > 0) {
            ...
            const words: string[] = Array.from(this.matrix.keys());
            const m: number[][] = Array.from(this.matrix.values());
            this.matrix.clear();
